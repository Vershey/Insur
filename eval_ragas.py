...
GOLD: list[GoldCase] = [
    ...
    GoldCase(
        ...
        expected_decision="COVERED",
        reference_answer=(
            "Wind and hail from a severe thunderstorm are covered perils under "
            ...
            "corroborates the storm event. No exclusion applies to wind or hail damage. "
            "Coverage is recommended pending standard inspection."
        ),
